          ...
          <Grid item xs={12}>
            <Router>
              ...
              <Routes>
                ...
                <Route
                  path="/login"
                  element={ısAuthenticated ? <Navigate to="/" /> : <Login />}
                />
                <Route
                  path="/auth/verify/:activation_token"
                  element={ısAuthenticated ? <Navigate to="/" /> : <Register />}
                />
                <Route
                  path="/register"
                  element={ısAuthenticated ? <Navigate to="/" /> : <Register />}
                ...
                <Route
                  ...
                  element={
                    ısAuthenticated ? <Navigate to="/" /> : <ForgetPassword />
                  }
                />
                <Route
                  path="/auth/resetPassword/:activatTokenForPass"
                  element={
                    ısAuthenticated ? <Navigate to="/" /> : <PasswordReset />
                  }
                />
