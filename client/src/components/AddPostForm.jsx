  ...
  return (
    <div>
      ...
      >
        ...
        <Typography
          sx={{ position: "absolute", left: 730, bottom: 440 }}
          variant="h7"
          align="right"
        >
          ...
          <Controller
            ...
            render={({ field }) => (
              <Select
                {...field}
                variant="standard"
                style={{ width: 410, margin: 30, left: 700, bottom: 250 }}
              >
                {tags.map((tag) => (
                  <MenuItem
          ...
          <div className="formInputs">
            ...
            {errors.title && (
              <small
                ...
                style={{ position: "absolute", bottom: 90, right: 450 }}
              >
            ...
            {errors.Subtitle && (
              <small
                className="text-danger"
                style={{ position: "absolute", bottom: 90, right: 150 }}
              >
        ...
        <Typography
          variant="h9"
          sx={{ width: 350, position: "absolute", left: 140, top: 380 }}
        >
          Note: Changes here will affect how your story appears in public places
          like Medium’s homepage and in subscribers’ inboxes — not the contents
          of the story itself.
        </Typography>
      </Dialog>
