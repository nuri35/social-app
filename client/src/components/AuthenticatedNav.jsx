    ...
    return (
      <div className="notifaction">
        <CardActionArea href={url}>
          <MenuItem>
            {!isRead ? <MyBadge color={"green"} /> : <></>}

            <div className="avNoti">
              {user.google ? (
                <Avatar src={user.google.avatar}></Avatar>
              ) : (
            ...
            <div>
              <strong className="mr-1">
                {" "}
                {user.google ? user.google.name : user.username}{" "}
              </strong>
              <span> {text} </span>
            </div>
          </MenuItem>
                  ...
                  {data?.length > 0 ? (
                    ...
                    <div>
                      <Empty
                        ...
                        description={
                          <div>
                            <span>Your notifications are shown here</span>
                            <hr></hr>
